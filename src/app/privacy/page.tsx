      ...
      <div className="space-y-6">
        <section>
          ...
          <ul className="list-disc ml-6 mt-2 text-gray-700">
            ...
            <li>Cookie Data</li>
            <li>Other technical data (e.g., IP address, operating system)</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            ...
            rights regarding your personal information, including the rights to
            access, correct, delete, or restrict the use of your data. To
        ...
        <section>
          ...
          <p className="text-gray-700">
            If you access our website from outside Spain, please note that your
            information may be transferred to, stored, and processed in Spain.
        ...
        <section>
          ...
          <p className="text-gray-700">
            ...
            Policy does not apply to those sites, and we are not responsible for
            their content or privacy practices. We encourage you to review the
        ...
        <section>
          ...
          <p className="text-gray-700">
            ...
            will be effective immediately upon posting on our website, with the
            updated &quot;Effective Date&quot; noted at the top of this page.
            Your continued use of our website constitutes your acceptance of any
            changes.
          </p>
        </section>
